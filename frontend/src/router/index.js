...
import {Login,UserLogin, UserRegister} from "@/views/auth/index.js";
...
const routes = [
    ...
    {path: '/auth/login', name: "auth.login", component: Login, meta: { title: 'Auth Login' ,guest:true}},
   ...
   //user route end=====
    ...
    },
    {
        ...
        children: [
            {path: '/user/login', name: "user.login", component: UserLogin, meta: { title: 'User Login' ,guest:true}},
        ],
    },
