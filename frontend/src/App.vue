<script setup>
import {HeaderPart,NavBar,CartSidebar,MobileMenu,LoginModal,NewsLetter,FooterPart} from "@/components";
      ...
      <div class="header">
        ...
        <div class="header-left">
          <a href="index.html" class="logo">
            <img src="@/dashboard_assets/assets/img/logo.png" alt="Logo">
          </a>
          <a href="index.html" class="logo logo-small">
            <img src="@/dashboard_assets/assets/img/logo-small.png" alt="Logo" width="30" height="30">
          </a>
        ...
        <div class="top-nav-search">
          <div class="main">
            <form class="search" method="post" action="https://doccure-html.dreamguystech.com/template/admin/index.html">
...
<span class="avatar">
<img class="avatar-img" alt="" src="@/dashboard_assets/assets/img/profiles/avatar-02.jpg">
</span>
                  ...
                  <li class="notification-message">
                    <a href="#">
                      <div class="media d-flex">
<span class="avatar">
<img class="avatar-img" alt="" src="@/dashboard_assets/assets/img/profiles/avatar-05.jpg">
</span>
                        <div class="media-body">
                  ...
                  <li class="notification-message">
                    <a href="#">
                      <div class="media d-flex">
                        <div class="avatar">
                          <img class="avatar-img" alt="" src="@/dashboard_assets/assets/img/profiles/avatar-03.jpg">
                        </div>
                        <div class="media-body">
                    ...
                    <a href="#">
                      <div class="media d-flex">
                        <div class="avatar avatar-sm">
                          <img class="avatar-img" alt="" src="@/dashboard_assets/assets/img/profiles/avatar-06.jpg">
                        </div>
                        <div class="media-body">
          ...
          <li class="nav-item dropdown main-drop">
            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
<span class="user-img">
<img src="@/dashboard_assets/assets/img/profiles/avatar-01.jpg" alt="">
<span class="status online"></span>
            ...
            <div class="dropdown-menu">
              <div class="user-header">
                <div class="avatar avatar-sm">
                  <img src="@/dashboard_assets/assets/img/profiles/avatar-01.jpg" alt="User Image" class="avatar-img rounded-circle">
                </div>
                <div class="user-text">
                  <h6>Robert Haddin</h6>
...
<img src="@/dashboard_assets/assets/img/icon/calendar.png" alt="User Image">
</span>
                    <div class="dash-count">
...
<img src="@/dashboard_assets/assets/img/icon/chart.png" alt="User Image">
</span>
                    <div class="dash-count">
                  ...
                  <div class="appointment-item">
                    ...
                    <div class="app-user">
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="app-img">
                            <img src="@/dashboard_assets/assets/img/profiles/avatar-02.jpg" alt="" class="img-fluid">
                            <div class="app-name">
                              <h6>Dr. Lester </h6>
                              <p>Orthopaedics</p>
                            </div>
                        ...
                        <div class="col-sm-6">
                          <div class="app-img justify-content-sm-end">
                            <img src="@/dashboard_assets/assets/img/profiles/avatar-05.jpg" alt="" class="img-fluid">
                            <div class="app-name">
                              <h6>Chris Harris</h6>
                              <p>ID : 781212, M</p>
                            </div>
                  ...
                  <div class="appointment-item">
                    ...
                    <div class="app-user">
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="app-img">
                            <img src="@/dashboard_assets/assets/img/profiles/avatar-06.jpg" alt="" class="img-fluid">
                            <div class="app-name">
                              <h6>Dr. Monroe</h6>
                        ...
                        <div class="col-sm-6">
                          <div class="app-img justify-content-sm-end">
                            <img src="@/dashboard_assets/assets/img/profiles/avatar-07.jpg" alt="" class="img-fluid">
                            <div class="app-name">
                              <h6>Bess Twishes</h6>
                              <p>ID : 787787, M</p>
                            </div>
                  ...
                  <div class="appointment-item">
                    ...
                    <div class="app-user">
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="app-img justify-content-sm-end">
                            <img src="@/dashboard_assets/assets/img/profiles/avatar-08.jpg" alt="" class="img-fluid">
                            <div class="app-name">
                              <h6>James Aaron</h6>
                              <p>ID : 781212, M</p>
                            </div>
                  ...
                  <div class="table-responsive">
                    <table class="table table-borderless hover-table">
                      ...
                      <tr>
                        ...
                        <td>
                          <h2 class="table-avatar">
                            <a href="profile.html"><img class="avatar avatar-img" src="@/dashboard_assets/assets/img/profiles/avatar-07.jpg" alt="User Image"></a>
                      ...
                      <tr>
                        ...
                        <td>
                          <h2 class="table-avatar">
                            <a href="profile.html"><img class="avatar avatar-img" src="@/dashboard_assets/assets/img/profiles/avatar-04.jpg" alt="User Image"></a>
                      ...
                      <tr>
                        ...
                        <td>
                          <h2 class="table-avatar">
                            <a href="profile.html"><img class="avatar avatar-img" src="@/dashboard_assets/assets/img/profiles/avatar-02.jpg" alt="User Image"></a>
                      ...
                      <tr>
                        ...
                        <td>
                          <h2 class="table-avatar">
                            <a href="profile.html"><img class="avatar avatar-img" src="@/dashboard_assets/assets/img/profiles/avatar-05.jpg" alt="User Image"></a>
                  ...
                  <div class="table-responsive">
                    <table class="table doc-table">
                      ...
                      <tr>
                        <td>
                          <h2 class="table-avatar">
                            <a class="avatar-pos avatar-online" href="profile.html"><img class="avatar avatar-img" src="@/dashboard_assets/assets/img/profiles/avatar-05.jpg" alt="User Image"></a>
                      ...
                      <tr>
                        <td>
                          <h2 class="table-avatar">
                            <a class="avatar-pos avatar-online" href="profile.html"><img class="avatar avatar-img" src="@/dashboard_assets/assets/img/profiles/avatar-10.jpg" alt="User Image"></a>
                      ...
                      <tr>
                        <td>
                          <h2 class="table-avatar">
                            <a class="avatar-pos avatar-offline" href="profile.html"><img class="avatar avatar-img" src="@/dashboard_assets/assets/img/profiles/avatar-11.jpg" alt="User Image"></a>
                      ...
                      <tr>
                        <td>
                          <h2 class="table-avatar">
                            <a class="avatar-pos avatar-offline" href="profile.html"><img class="avatar avatar-img" src="@/dashboard_assets/assets/img/profiles/avatar-13.jpg" alt="User Image"></a>
                  ...
                  <div class="table-responsive">
                    <table class="table table-borderless">
                      ...
                      <tr class="speciality-item">
                        <td class="spl-name">
                          <div class="spl-box">
                            <img src="@/dashboard_assets/assets/img/icon/urology.png" alt="User Image">
                          </div>
                          <div class="spl-count">
                            <h6>Urology</h6>
                            <p>Patients : 400</p>
                      ...
                      <tr class="speciality-item">
                        <td class="spl-name">
                          <div class="spl-box">
                            <img src="@/dashboard_assets/assets/img/icon/neurology.png" alt="User Image">
                          </div>
                          <div class="spl-count">
                            <h6>Neurology</h6>
                            <p>Patients : 980 </p>
                      ...
                      <tr class="speciality-item">
                        <td class="spl-name">
                          <div class="spl-box">
                            <img src="@/dashboard_assets/assets/img/icon/ortho.png" alt="User Image">
                          </div>
                          <div class="spl-count">
                            <h6>Orthopedic</h6>
                            <p>Patients : 600</p>
                      ...
                      <tr class="speciality-item">
                        <td class="spl-name">
                          <div class="spl-box">
                            <img src="@/dashboard_assets/assets/img/icon/cardio.png" alt="User Image">
                          </div>
                          <div class="spl-count">
                            <h6>Urology</h6>
                            <p>Patients : 400</p>
                      ...
                      <tr class="speciality-item">
                        <td class="spl-name">
                          <div class="spl-box">
                            <img src="@/dashboard_assets/assets/img/icon/dental.png" alt="User Image">
                          </div>
                          <div class="spl-count">
                            <h6>Urology</h6>
                            <p>Patients : 400</p>
                      ...
                      <div class="appointment-items">
                        <div class="app-user">
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="app-img">
                                <img src="@/dashboard_assets/assets/img/profiles/avatar-09.jpg" alt="" class="img-fluid">
                                <div class="app-name">
                                  <h6>Dr. Rayan </h6>
                                  <p>Orthopaedics</p>
                                </div>
                            ...
                            <div class="col-sm-6">
                              <div class="app-img">
                                <img src="@/dashboard_assets/assets/img/profiles/avatar-13.jpg" alt="" class="img-fluid">
                                <div class="app-name">
                                  <h6>Chris Harris</h6>
                                  <p>ID : 781212, M</p>
                                </div>
                      ...
                      <div class="appointment-items">
                        <div class="app-user">
                          <div class="row">
                            <div class="col-6">
                              <div class="app-img">
                                <img src="@/dashboard_assets/assets/img/profiles/avatar-12.jpg" alt="" class="img-fluid">
                                <div class="app-name">
                                  <h6>Dr. Alex </h6>
                                  <p>Orthopaedics</p>
                                </div>
                      ...
                      <div class="appointment-items">
                        <div class="app-user">
                          <div class="row">
                            <div class="col-6">
                              <div class="app-img">
                                <img src="@/dashboard_assets/assets/img/profiles/avatar-03.jpg" alt="" class="img-fluid">
                                <div class="app-name">
                                  <h6>Dr. Shofia </h6>
                                  <p>Orthopaedics</p>
                                </div>
                            ...
                            <div class="col-6">
                              <div class="app-img">
                                <img src="@/dashboard_assets/assets/img/profiles/avatar-10.jpg" alt="" class="img-fluid">
                                <div class="app-name">
                                  <h6>Harris Chris</h6>
                                  <p>ID : 781212, M</p>
                                </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="country-item">
                    <div class="con-name">
                      <div class="flag-box">
                        <img class="rounded-circle" src="@/dashboard_assets/assets/img/flags/flag-01.png" alt="User Image">
                      </div>
                      <div class="flag-name">
                  ...
                  <div class="country-item">
                    <div class="con-name">
                      <div class="flag-box">
                        <img class="rounded-circle" src="@/dashboard_assets/assets/img/flags/flag-02.png" alt="User Image">
                      </div>
                      <div class="flag-name">
                  ...
                  <div class="country-item">
                    <div class="con-name">
                      <div class="flag-box">
                        <img class="rounded-circle" src="@/dashboard_assets/assets/img/flags/flag-03.png" alt="User Image">
                      </div>
                      <div class="flag-name">
                  ...
                  <div class="country-item">
                    <div class="con-name">
                      <div class="flag-box">
                        <img class="rounded-circle" src="@/dashboard_assets/assets/img/flags/flag-04.png" alt="User Image">
                      </div>
                      <div class="flag-name">
                  ...
                  <div class="country-item">
                    <div class="con-name">
                      <div class="flag-box">
                        <img class="rounded-circle" src="@/dashboard_assets/assets/img/flags/flag-05.png" alt="User Image">
                      </div>
                      <div class="flag-name">
                        <p class="user-name"><span>UAE</span> <span class="d-block text-muted">300 Patients</span></p>
                      </div>
